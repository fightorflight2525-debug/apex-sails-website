    ...
    <>
      <section className="bg-charcoal pt-32 pb-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          {/* SAUCE-314 ("fix gallery", his GO): most photos here are the Wholesale
              Shade supplier gallery and another installer's (vault photo-index),
              so the page makes no ownership claim. */}
